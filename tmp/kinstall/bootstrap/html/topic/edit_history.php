...
<div class="kblock khistory">
	<div class="kheader">
		<span class="ktoggler"><a class="ktoggler icon icon-minus-circle close" title="<?php echo JText::_('COM_KUNENA_TOGGLER_COLLAPSE') ?>" data-toggle="collapse" data-target="#khistory"></a></span>
	...
	<div class="kcontainer  collapse in" id="khistory">
		<div class="kbody">
					...
					<tr>
						...
						<td class="kmessage-left khistorymsg">
							...
							<div class="kmsgattach well">
								...
								<ul class="kfile-attach unstyled">
