...
<div class="kblock kgenstats">
	<div class="kheader">
		<span class="ktoggler"><a class="ktoggler icon icon-minus-circle close" title="<?php echo JText::_('COM_KUNENA_TOGGLER_COLLAPSE') ?>" data-toggle="collapse" data-target="#kgenstats_tbody"></a></span>
		<h2><span><?php echo $this->escape($this->config->board_title); ?> <?php echo JText::_('COM_KUNENA_STAT_FORUMSTATS'); ?></span></h2>
	</div>
	<div class="kcontainer  collapse in" id="kgenstats_tbody">
		<div class="kbody">
...
<div class="kblock kpopsubjstats">
	<div class="kheader">
		<span class="ktoggler"><a class="ktoggler icon icon-minus-circle close" title="<?php echo JText::_('COM_KUNENA_TOGGLER_COLLAPSE') ?>" data-toggle="collapse" data-target="#kpopsubstats-tbody"></a></span>
		<h2><span><?php echo $top[0]->title ?></span></h2>
	</div>
	<div class="kcontainer  collapse in" id="kpopsubstats-tbody">
		<div class="kbody">
			<table class="table table-striped table-condensed">
				<tbody>
					<tr class="ksth" >
						...
						<th class="kbar" style="width:60%">&nbsp;</th>
						<th class="kname" style="width:100px"><?php echo $top[0]->titleCount ?></th>
					</tr>
					...
					<tr class="k<?php echo $this->escape($tabclass[$id & 1]); ?>">
						...
						<td class="kcol-mid">
							...
							<?php /*<img class="kstats-bar" src="<?php echo $template->getImagePath('bar.png') ?>" alt="" height="10" width="<?php echo $item->percent ?>%" /> */ ?>
						</td>
						<td class="kcol-last">
							<?php echo $item->count ?>
						</td>
