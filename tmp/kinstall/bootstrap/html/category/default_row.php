...
<tr class="<?php echo $this->getTopicClass('k', 'row') ?>">
	...
	<td class="kcol-first kcol-ktopicreplies hidden-phone">
		<span class="knumber"><?php echo $this->formatLargeNumber ( max(0,$this->topic->getTotal()-1) ); ?></span><span><?php echo JText::_('COM_KUNENA_GEN_REPLIES') ?></sapn>
	</td>
	...
	<td class="kcol-mid kcol-ktopiclastpost">
		<div class="klatest-post-info">
			...
			<div class="ktopic-latest-post-avatar hidden-phone"> <?php echo $this->topic->getLastPostAuthor()->getLink( $this->topic->avatar ) ?></div>
			<?php endif; ?>
