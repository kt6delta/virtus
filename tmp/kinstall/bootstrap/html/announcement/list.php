...
<table class="kannouncement table table-striped">
	<tbody id="kannouncement_body">
		<tr class="ksth">
			<?php if ($this->actions): ?>
			<th class="kcol-annid" style="width:1%"><input type="checkbox" name="toggle" value="" onclick="Joomla.checkAll(this);" /></th>
			<?php endif; ?>
			<th class="kcol-annid" style="width:1%"><?php echo JText::_('COM_KUNENA_ANN_ID'); ?></th>
		...
		<tr class="krow1">
			<td colspan="3" class="kcol krowmoderation">
				<div class="pagination"><?php echo $pagination = $this->getPagination(5); ?></div>
			</td>
