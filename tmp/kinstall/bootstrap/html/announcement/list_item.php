...
?>
		<tr class="krow<?php echo $this->k;?>">
			...
			<td class="kcol-mid kcol-annedit">
				<?php if ($this->canEdit()) echo JHtml::_('kunenagrid.task', $this->row, 'edit.png', JText::_('COM_KUNENA_ANN_EDIT'), 'edit') ?>
			</td>
			<td class="kcol-mid kcol-anndelete">
				<?php if ($this->canDelete()) echo JHtml::_('kunenagrid.task', $this->row, 'remove.png', JText::_('COM_KUNENA_ANN_DELETE'), 'delete') ?>
			</td>
			<?php endif; ?>
		</tr>
