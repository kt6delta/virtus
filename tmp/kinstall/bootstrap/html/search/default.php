...
<div class="kblock kadvsearch">
	<div class="kheader">
		<!--<span class="ktoggler"><a data-toggle="collapse" data-target="#kforumsearch" class="ktoggler icon icon-minus-circle <?php echo $this->search_class; ?>" title="<?php echo $this->search_title ?>"></a></span>-->
		<h2><span><?php echo JText::_('COM_KUNENA_SEARCH_ADVSEARCH'); ?></span></h2>
	</div>
	<div class="kcontainer" id="kforumsearch" >
		<div class="kbody">
	...
	<table class="table">
		<tbody id="advsearch"<?php echo $this->search_style; ?>>
			...
			<tr>
				<th colspan="2">
					<div class="kheader">
						<span class="ktoggler fltrt pull-right" id="search_opt_status"><a class="ktoggler icon icon-minus-circle close" title="<?php echo JText::_('COM_KUNENA_TOGGLER_COLLAPSE') ?>" data-toggle="collapse" data-target="#advsearch_options"></a></span>
			...
			<tr>
			 <td colspan="2">
			  <div class="collapse" id="advsearch_options">
			   <table class="table">
				<tr class="krow1">
				<td class="kcol">
<?php /*
...
*/ ?>
				...
				<td class="kcol">
					...
					<fieldset class="fieldset">
						...
						<label class="label" for="show0"><?php echo JText::_('COM_KUNENA_SEARCH_SHOW_NORMAL'); ?></label><br />
						<input id="show1" type="radio" name="show" value="1" <?php if ($this->state->get('query.show') == 1) echo 'checked="checked"'; ?> />
						<label class="label" for="show1"><?php echo JText::_('COM_KUNENA_SEARCH_SHOW_UNAPPROVED'); ?></label><br />
						<input id="show2" type="radio" name="show" value="2" <?php if ($this->state->get('query.show') == 2) echo 'checked="checked"'; ?> />
						<label class="label" for="show2"><?php echo JText::_('COM_KUNENA_SEARCH_SHOW_TRASHED'); ?></label><br />
					</fieldset>
					<?php endif; ?>
				</td>
				</tr>
...
<div class="kblock ksearchresult">
	<div class="kheader">
		<span class="ktoggler"><a class="ktoggler icon icon-minus-circle close" title="<?php echo JText::_('COM_KUNENA_TOGGLER_COLLAPSE') ?>" data-toggle="collapse" data-target="#ksearchresult"></a></span>
		<h2>
			<span>
	...
	<div class="kcontainer  collapse in" id="ksearchresult">
		<div class="kbody">
	<?php if ($this->error) : ?>
		<div>
			<?php echo $this->error; ?>
...
<table>
	<tbody>
		...
		<tr class="ksth">
			...
			<div class="pagination"><?php echo $this->getPagination(5); ?></div>
			<?php endif; ?>
			</th>
		</tr>
	</tbody>
