...
<table
	class="table <?php
	echo isset ( $this->category->class_sfx ) ? $this->escape($this->category->class_sfx) : '';
	?>">
	<tbody>
		...
		<tr class="krow1">
			...
			<td class="kcol-mid">
				<span class="editlinktip" title="<?php echo JText::_('COM_KUNENA_MYPROFILE_BIRTHDATE'); ?>::<?php echo JText::_('COM_KUNENA_MYPROFILE_BIRTHDATE_DESC'); ?>" >
		...
		<tr class="krow2">
			...
			<td class="kcol-mid">
				<span class="editlinktip" title="<?php echo JText::_('COM_KUNENA_MYPROFILE_WEBSITE_NAME'); ?>::<?php echo JText::_('COM_KUNENA_MYPROFILE_WEBSITE_NAME_DESC'); ?>" >
		...
		<tr class="krow1">
			...
			<td class="kcol-mid">
				<span class="editlinktip" title="<?php echo JText::_('COM_KUNENA_MYPROFILE_WEBSITE_URL'); ?>::<?php echo JText::_('COM_KUNENA_MYPROFILE_WEBSITE_URL_DESC'); ?>" >
		...
		<tr class="krow<?php echo (++$i & 1)+1;?>">
			...
			<td class="kcol-mid">
				<span class="editlinktip" title="<?php echo JText::_("COM_KUNENA_MYPROFILE_{$social}"); ?>::<?php echo JText::_("COM_KUNENA_MYPROFILE_{$social}_DESC"); ?>" >
		...
		<tr class="krow<?php echo (++$i & 1)+1;?>">
			...
			<td class="kcol-mid">
				<textarea class="ktxtarea editlinktip" title="<?php echo JText::_('COM_KUNENA_MYPROFILE_SIGNATURE'); ?>::<?php echo JText::_('COM_KUNENA_MYPROFILE_SIGNATURE_DESC'); ?>" maxlength="<?php echo intval($this->config->maxsig) ?>" name="signature" id="kbbcode-message" rows="10" cols="30"><?php echo $this->escape($this->profile->signature) ?></textarea>
