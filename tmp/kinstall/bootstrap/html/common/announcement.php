...
<div class="kblock kannouncement">
	<div class="kheader">
		<span class="ktoggler"><a class="ktoggler icon icon-minus-circle close" title="<?php echo JText::_('COM_KUNENA_TOGGLER_COLLAPSE') ?>" data-toggle="collapse" data-target="#kannouncement"></a></span>
	...
	<div class="kcontainer  collapse in" id="kannouncement">
		<div class="kbody">
			<div class="kanndesc">
