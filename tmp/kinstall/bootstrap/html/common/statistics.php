...
<div class="kblock kfrontstats">
	<div class="kheader">
		<span class="ktoggler"><a class="ktoggler icon icon-minus-circle close" title="<?php echo JText::_('COM_KUNENA_TOGGLER_COLLAPSE') ?>" data-toggle="collapse" data-target="#kfrontstats-tbody"></a></span>
	...
	<div class="kcontainer  collapse in" id="kfrontstats-tbody">
		<div class="kbody">
			<table class="table table-striped" id="kfrontstats">
				<tr class="krow1">
					<td class="kcol-first">
						<div class="kstatsicon"></div>
					</td>
					<td class="kcol-mid km row">
						<ul id="kstatslistleft" class="fltlft unstyled span6">
						...
						<ul id="kstatslistright" class="fltrt kright unstyled span6">
							<li class="hidden-phone"><?php echo JText::_('COM_KUNENA_STAT_TOTAL_USERS'); ?>: <strong><?php echo $this->getUserlistLink('', $this->memberCount) ?></strong> <br> <?php echo JText::_('COM_KUNENA_STAT_LATEST_MEMBERS'); ?>: <strong><?php echo $this->latestMemberLink ?></strong></li>
							<li>&nbsp;</li>
