...
<div class="kblock kwhoisonline">
	<div class="kheader">
		<span class="ktoggler"><a class="ktoggler icon icon-minus-circle close" title="<?php echo JText::_('COM_KUNENA_TOGGLER_COLLAPSE') ?>" data-toggle="collapse" data-target="#kwhoisonline"></a></span>
		<h2><span><span class="ktitle km"><?php echo JText::_('COM_KUNENA_VIEW_COMMON_WHO_TITLE') ?></span></span></h2>
	</div>
	<div class="kcontainer  collapse in" id="kwhoisonline">
		<div class="kbody">
	<table class = "table table-striped">
		<tr class = "krow2">
			<td class = "kcol-first">
				<div class="kwhoicon kicon-profile kicon-profile-users"></div>
			</td>
