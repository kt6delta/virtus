      ...
      <p class="readmore btn btn-default">
        <a href="<?php echo $link; ?>">
          ...
          elseif ($params->get('show_readmore_title', 0) == 0) :
            ...
            $readmoreShowTitle = version_compare(JVERSION, '4', 'ge') ? JText::sprintf('JGLOBAL_READ_MORE_TITLE', HTMLHelper::_('string.truncate', $item->title, $params->get('readmore_limit'))) : JText::_('COM_CONTENT_READ_MORE') ." ".HTMLHelper::_('string.truncate', $item->title, $params->get('readmore_limit'));
